...
目标：统一回答“当前最重要的主题是什么、为什么、证据是什么、涉及谁、建议动作是什么”。首页、周报和月报后续都应消费 Narrative，而不是各自生成独立判断。

当前首页规则：
- 今日判断、关注窗口、证据事件必须来自同一个 Narrative。
...
- 达不到独立证据门槛时，清空关注窗口并降级为“今日要点”，不展示硬凑趋势。
- 如果没有稳定关注窗口，首页降级为“今日要点”，只展示入库事件，不强写趋势判断。
